...
public class ScoreCalculator {
    ...
    public static String generateReport(int score, Category category, GeneralTest test) {
        ...
        report.append("📊 RÉSULTAT DU TEST\n");
        report.append("════════════════════════════\n\n");
        ...
        switch (category) {
            case TRES_BAS:
                report.append("❌ Score très bas\n\n");
                report.append("Votre score indique un niveau très faible.\n");
                report.append("Nous vous recommandons de consulter un professionnel.\n");
                break;

            case BAS:
                report.append("⚠️ Score bas\n\n");
                report.append("Votre score est inférieur à la moyenne.\n");
                report.append("Considérez une consultation professionnelle.\n");
                break;

            case MOYEN:
                report.append("ℹ️ Score moyen\n\n");
                report.append("Votre score est dans la moyenne.\n");
                report.append("Continuez à surveiller votre bien-être.\n");
                break;

            case ELEVE:
                report.append("✅ Score élevé\n\n");
                report.append("Votre score est bon.\n");
                report.append("Maintenez vos bonnes habitudes.\n");
                break;

            case TRES_ELEVE:
                report.append("🎉 Score très élevé\n\n");
                report.append("Excellent résultat!\n");
                report.append("Vous maintenez un excellent niveau de bien-être.\n");
                break;
        }

        report.append("\n════════════════════════════\n");
        report.append("Merci d'avoir complété ce test.\n");
