...
#[ORM\Entity(repositoryClass: SpecificAnswerRepository::class)]
#[ORM\Table(name: 'specific_answers')]
class SpecificAnswer
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
    ...
    #[ORM\ManyToOne(targetEntity: SpecificQuestion::class, inversedBy: 'answers')]
