...
#[ORM\Entity(repositoryClass: SpecificTestRepository::class)]
#[ORM\Table(name: 'specific_tests')]
class SpecificTest
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function addQuestion(SpecificQuestion $question): static
    {
    ...
    public function removeQuestion(SpecificQuestion $question): static
    {
