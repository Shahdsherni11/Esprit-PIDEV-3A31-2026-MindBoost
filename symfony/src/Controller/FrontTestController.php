...
class FrontTestController extends AbstractController
{
    ...
    public function submitGeneralTest(Request $request): Response
    {
        $test = $this->generalTestRepository->findOneBy(['status' => 'ACTIVE']);
    ...
    public function submitSpecificTest(int $id, Request $request): Response
    {
