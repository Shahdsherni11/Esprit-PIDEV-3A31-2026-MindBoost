...
class UserPdfController extends AbstractController
{
    ...
    public function exportHistoryPdf(UserProgressService $userProgressService): Response
    {
        $userId = 1;
    ...
    public function exportStatisticsPdf(UserProgressService $userProgressService): Response
    {
        $userId = 1;
