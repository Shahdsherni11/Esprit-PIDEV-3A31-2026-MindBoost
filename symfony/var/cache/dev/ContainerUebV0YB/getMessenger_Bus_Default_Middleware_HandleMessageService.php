...
class getMessenger_Bus_Default_Middleware_HandleMessageService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance = new \Symfony\Component\Messenger\Middleware\HandleMessageMiddleware(new \Symfony\Component\Messenger\Handler\HandlersLocator(['App\\Message\\SendReminderMessage' => new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['.messenger.handler_descriptor.W_m9wUH'] ?? $container->load('get_Messenger_HandlerDescriptor_WM9wUHService'));
            ...
            yield 0 => ($container->privates['.messenger.handler_descriptor.KMq4SyQ'] ?? $container->load('get_Messenger_HandlerDescriptor_KMq4SyQService'));
