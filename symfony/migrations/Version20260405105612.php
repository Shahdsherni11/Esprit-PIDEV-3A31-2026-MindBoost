 ...
 */
final class Version20260405105612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE specific_answers (id INT AUTO_INCREMENT NOT NULL, answer_text LONGTEXT NOT NULL, score INT NOT NULL, answer_order INT NOT NULL, created_at DATETIME NOT NULL, question_id INT DEFAULT NULL, INDEX IDX_A332A1ED1E27F6BF (question_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE specific_questions (id INT AUTO_INCREMENT NOT NULL, question_text LONGTEXT NOT NULL, question_order INT NOT NULL, created_at DATETIME NOT NULL, test_id INT DEFAULT NULL, INDEX IDX_E48079EB1E5D0459 (test_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
